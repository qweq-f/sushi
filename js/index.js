document.addEventListener('DOMContentLoaded', () =>
{
    ...
    productCards.forEach(card => {
        ...
        // addToCartBytton.addEventListener('click', () => {
        //     const quantity = parseInt(card.querySelector('.quantity').textContent);// получение количества товара
        //     addToCart(productId, productTitle, productPrice, quntity, productWeight);// вызываем функцию добавление в корзину
        // });
    });

    // функция добавления товара в корзину
    const addToCart = (productId, productTitle, productPrice, quantity, productWeight) => {
        ...
        localStorage.setItem('cart',JSON.stringify(cart));//сохранение корзину в localStorage
